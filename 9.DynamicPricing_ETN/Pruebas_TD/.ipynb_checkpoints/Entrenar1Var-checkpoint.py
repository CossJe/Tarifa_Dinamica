# -*- coding: utf-8 -*-
"""
Created on Thu Aug 28 14:06:37 2025
...
def Obtener_Ing_De_Carac(df_original, atribute, Param, c):
    """
...
def GridSearch(df, Emp, name):
    ...
    for rate in np.arange(1.2, 3, 0.1):
        for n, n_terms in zip(Enes, Arm):
            ...
            # Se asume que la función Obtener_Ing_De_Carac ha sido modificada para no requerir df1
            df_features = Obtener_Ing_De_Carac(df_aux, name, (rate, n, n_terms), 0)
    ...
    df_features, carac = Obtener_Ing_De_Carac(df_aux, name, Param, 1)
