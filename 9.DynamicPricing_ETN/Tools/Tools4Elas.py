...
def Calculate_Min_Max_Optimal_Tarify( df, days_before, grados=(1, 2, 3), resampling=True, resamp_interval = 10, window=7,
    ...
    return [df_agg, df_resampled, resultado_opt,E_global]
...
def MainElasA():
    ...
    [df_agg, df_resampled, resultado_opt,E_global]= Calculate_Min_Max_Optimal_Tarify( Frame, 365, grados=(1, 2, 3), resampling=True, 
                                     resamp_interval = 10, window=7,
                                            Plotting_Resume=False, Plotting_Resamp=False, 
                                            Plotting_Results=False, Plotting_Elasticity=False,
                                            path_fold=json_Net )
